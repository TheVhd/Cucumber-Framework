...
Feature: US_029As a user, I should be able to check valid and invalid passwords
  Background:User write suitable password
    Given user goes to the "https://qa-test.hypnotes.net/register"
    And user types "hamza yilmaz" to the fullname input
    When cihan types "hamza@gmail.com" to the email input
